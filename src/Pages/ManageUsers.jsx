...
const ManageUsers = () => {
    ...
    const getAllUserData = () => {
        const url = "https://exptradezglobsbackend.onrender.com/api/alluserdata";
        axios
            .get(url)
            .then((response) => {
    ...
    const Verify = (id) => {
            const url = `https://exptradezglobsbackend.onrender.com/api/UserVerify/${id}`;
            axios.patch(url)
                .then((response) => {
    ...
    return (
        <>
            <div className="w-full h-max px-6 py-10 flex flex-col gap-2 phone:gap-8 bg-[#f9fbfd] text-[rgb(87,89,98)]">
                <p className="text-[27px] font-semibold">Exptradezglobs users list</p>
